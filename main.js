...
let message1 = "Life is like riding a bicycle. To keep your balance, you must keep moving";
console.log(`${famous_person} once said, "${message1}"`);
// 6. Stripping Names: Store a person’s name, and include some whitespace characters at the beginning and end of the name. Make sure you use each character combination, "\t" and "\n", at least once. Print the name once, so the whitespace around the name is displayed. Then print the name after striping the white spaces.
let fname = "Erum\tMehboob";
let fname1 = "Erum\nMehboob";
console.log(fname);
console.log(fname1);
...
let Names = ["yaram", "salaar", "jahaan", "wajdaan"];
console.log(Names[0]);
console.log(Names[1]);
console.log(Names[2]);
console.log(Names[3]);
...
let names = ["yaram", "salaar", "jahaan", "wajdaan"];
let message2 = "is the founder of PIAIC.";
...
function make_album(artist_name, title_name, number_of_tracks = null) {
    let album = {
